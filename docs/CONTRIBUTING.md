...
Before contributing, we encourage you to read our [README](README.md) and [LICENSE](LICENSE.MD) also found in this repository. If you have any questions that aren't answered in this repository, feel free to [contact us](mailto:prime@cdc.gov).
...
If you think you found a bug in PHDI, search our [issues list](https://github.com/CDCgov/phdi-azure/issues) in case someone has opened a similar issue. We'll close duplicate issues to help keep our backlog neat and tidy.
