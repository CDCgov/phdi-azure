...
def main(message: func.QueueMessage) -> None:
    ...
    result = json.dumps({
        ...
        'expiration_time': (message.expiration_time.isoformat()
                            if message.expiration_time else None),
        'insertion_time': (message.insertion_time.isoformat()
                           if message.insertion_time else None),
        'time_next_visible': (message.time_next_visible.isoformat()
                              if message.time_next_visible else None),
